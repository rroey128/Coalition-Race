...
bin/cRace: bin/main.o bin/Coalition.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/MandatesJoinPolicy.o bin/LastOfferJoinPolicy.o bin/MandatesSelectionPolicy.o bin/EdgeWeightSelectionPolicy.o
	g++ -o bin/cRace bin/Coalition.o bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/MandatesJoinPolicy.o bin/LastOfferJoinPolicy.o bin/MandatesSelectionPolicy.o bin/EdgeWeightSelectionPolicy.o
